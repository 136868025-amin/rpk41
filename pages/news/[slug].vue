    ...
    <div class="min-h-screen bg-slate-50 pb-12">
        ...
        <div v-else-if="news" class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <nav class="flex text-sm text-slate-500 mb-6">
                ...
                <span class="mx-2">/</span>
                <span class="text-slate-800 truncate max-w-[200px]">{{ news.title }}</span>
            </nav>
            ...
            <article class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div class="p-8">
                    ...
                    <div class="flex items-center gap-4 text-slate-500 text-sm mb-8 pb-8 border-b border-slate-100">
                    ...
                    <div class="prose prose-lg max-w-none text-slate-600" v-html="news.content"></div>

                    <!-- Gallery -->
                    <div v-if="news.gallery && news.gallery.length > 0" class="mt-12 pt-12 border-t border-slate-100">
                        <h3 class="text-xl font-bold text-slate-800 mb-6">รูปภาพเพิ่มเติม</h3>
            ...
            <div v-if="relatedNews.length > 0" class="mt-12">
                <h2 class="text-2xl font-bold text-slate-800 mb-6">ข่าวสารที่เกี่ยวข้อง</h2>
            ...
            <div v-if="recommendedNews.length > 0" class="mt-12 pt-12 border-t border-slate-100">
                <h2 class="text-2xl font-bold text-slate-800 mb-6">ข่าวแนะนำ</h2>
                <div class="grid md:grid-cols-2 gap-6">
        ...
        <div v-else class="text-center py-24">
            <h1 class="text-2xl font-bold text-slate-800 mb-2">ไม่พบข่าวสาร</h1>
