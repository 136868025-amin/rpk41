    ...
    <div class="min-h-screen bg-slate-50 pb-12">
        ...
        <div class="bg-white border-b border-slate-200">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <h1 class="text-3xl md:text-4xl font-bold text-slate-800 mb-4">ติดต่อเรา</h1>
                <p class="text-slate-600 text-lg">ช่องทางการติดต่อและแผนที่การเดินทาง</p>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div v-else-if="schoolConfig" class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                            ...
                            <h3 class="font-bold text-slate-800 mb-2">ที่อยู่</h3>
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                            <div
                                class="w-10 h-10 bg-emerald-100 rounded-full flex items-center justify-center text-xl mb-4">
                                📞
                            </div>
                            <h3 class="font-bold text-slate-800 mb-2">เบอร์โทรศัพท์</h3>
                            <p class="text-slate-600 text-sm">
                                <a :href="`tel:${schoolConfig.contact?.phone}`" class="hover:text-primary-600">
                                    {{ schoolConfig.contact?.phone }}
                                </a>
                            </p>
                            <p v-if="schoolConfig.contact?.fax" class="text-slate-600 text-sm mt-1">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                            <div
                                class="w-10 h-10 bg-amber-100 rounded-full flex items-center justify-center text-xl mb-4">
                                📧
                            </div>
                            <h3 class="font-bold text-slate-800 mb-2">อีเมล</h3>
                            <p class="text-slate-600 text-sm">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                            <div
                                class="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center text-xl mb-4">
                                🌐
                            </div>
                            <h3 class="font-bold text-slate-800 mb-2">โซเชียลมีเดีย</h3>
                    ...
                    <!-- Map -->
                    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden h-[400px]">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
                    <h2 class="text-2xl font-bold text-slate-800 mb-6">ส่งข้อความถึงเรา</h2>
                    <form @submit.prevent="handleSubmit" class="space-y-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-1">หัวข้อเรื่อง</label>
