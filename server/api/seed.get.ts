  ...
  try {
    ...
    const personnel = await Personnel.insertMany([
      ...
      },
      {
        ...
        photo: '/images/staff/staff-2.png',
        department: 'administrators',
        orderIndex: 2,
      ...
      },
      {
        ...
        photo: '/images/staff/staff-3.png',
        department: 'administrators',
        orderIndex: 3,
      },
      {
        ...
        photo: '/images/staff/staff-4.png',
        department: 'teachers',
        orderIndex: 1,
      },
      {
        ...
        photo: '/images/staff/staff-5.png',
        department: 'teachers',
        orderIndex: 2,
      },
      {
        ...
        photo: '/images/staff/staff-6.png',
        department: 'teachers',
        orderIndex: 3,
      },
      {
        ...
        photo: '/images/staff/staff-7.png',
        department: 'teachers',
        orderIndex: 4,
      },
      {
        ...
        photo: '/images/staff/staff-8.png',
      ...
      },
      {
        ...
        photo: '/images/staff/staff-9.png',
        department: 'support_staff',
        orderIndex: 2,
      },
    ])
