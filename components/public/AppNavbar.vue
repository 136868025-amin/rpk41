                ...
                <div class="hidden lg:flex items-center gap-1">
                    <NuxtLink v-for="item in menuItems" :key="item.path" :to="item.path"
                        ...
                        :class="isActive(item.path)
                            ...
                            : 'text-slate-600 dark:text-slate-300 hover:text-primary-700 hover:bg-primary-50 dark:hover:bg-slate-800'">
                        {{ item.label }}
                    </NuxtLink>
                ...
                <div v-if="isMobileMenuOpen"
                    ...
                    <div class="space-y-1 px-2">
                        <NuxtLink v-for="(item, index) in menuItems" :key="item.path" :to="item.path"
                            ...
                            :class="isActive(item.path)
                                ? 'text-primary-700 bg-primary-50 dark:text-primary-400 dark:bg-primary-900/30'
                                : 'text-slate-600 dark:text-slate-300 hover:text-primary-700 hover:bg-slate-50 dark:hover:bg-slate-800'"
